...
class TokenizerService(dictionary: Map[String, String]):
  ...
  import Chat.TokenizerService._
  ...
  /** Converts a given user input into a set of lexemes for further tokenization
    ...
    *   a set of lexemes
    */
  // TODO: ask if we need to be iteratively splitting the input, to avoid reading the whole input at once
...
private object TokenizerService:
  ...
  // TODO: can we do this filtering using a constant map? we don't have other ways to disambiguate products and brands
